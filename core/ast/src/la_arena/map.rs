//! Vendored from rust-analyzer's la-arena crate (v0.3.1).
//! Original source: <https://github.com/rust-lang/rust-analyzer/tree/master/lib/la-arena>
//! License: MIT OR Apache-2.0
//! Copyright: rust-analyzer contributors

use std::iter::Enumerate;
use std::marker::PhantomData;

use crate::la_arena::Idx;
...
/// An owned iterator over the arena's elements.
