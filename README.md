...
The five-case gate is now pinned to verifier B and certifies exactly eleven positive endpoints plus the negative false-spec certificate. The deterministic fake self-test freezes the bridge contract and can be run without mounting `docker.sock`:
