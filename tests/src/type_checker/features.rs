...
mod import_tests {
    ...
    mod visibility {
        ...
        fn test_visibility_private_child_scope_accessible() {
            ...
            let result = try_type_check(source);
            always!(result.is_ok(), "Root-level symbols should be accessible");
        }
    ...
    mod qualified_name_resolution {
        ...
        fn test_qualified_name_resolution_nested() {
            ...
            let result = try_type_check(source);
            always!(result.is_ok(), "Type resolution should work at root level");
        }
    }
    ...
    mod import_resolution {
        ...
        fn test_import_resolution_error_not_found() {
            ...
            let result = try_type_check(source);
            always!(result.is_err(), "Import of nonexistent path should fail");
            if let Err(error) = result {
                let error_msg = error.to_string();
                always!(
                    error_msg.contains("cannot resolve import path"),
    ...
    mod name_shadowing {
        ...
        fn test_local_definition_shadows_import() {
            ...
            let result = try_type_check(source);
            always!(result.is_ok(), "Local definition should be usable");
        }
    }
    ...
    mod import_infrastructure {
        ...
        fn test_plain_import_registered() {
            ...
            let result = try_type_check(source);
            always!(result.is_err(), "Unresolvable import should fail");
        }
        ...
        fn test_partial_import_multiple_items() {
            ...
            let result = try_type_check(source);
            always!(result.is_err(), "Multiple unresolvable imports should fail");
            if let Err(error) = result {
                let error_msg = error.to_string();
                always!(
                    error_msg.contains("cannot resolve import path"),
    ...
    mod extern_prelude_tests {
        ...
        fn test_visibility_tracking_in_symbol_table() {
            ...
            let result = try_type_check(source);
            always!(result.is_ok(), "Symbol table tracks struct definitions");
        }
        ...
        fn test_find_module_root_lib_inf() {
            ...
            always!(root.is_some(), "Should find src/lib.inf");
        ...
        fn test_private_enum_definition() {
            ...
            let arena = build_ast(source.to_string());
            let result = TypeCheckerBuilder::build_typed_context(arena);
            always!(result.is_ok(), "Private enum should be registerable");
        }
        ...
        fn test_struct_with_multiple_fields() {
            ...
            let result = try_type_check(source);
            always!(result.is_ok(), "Struct with multiple fields should work");
        }
        ...
        fn test_multiple_struct_definitions() {
            ...
            let result = try_type_check(source);
            always!(result.is_ok(), "Multiple struct definitions should work");
        }
        ...
        fn test_empty_source_with_visibility() {
            let source = r#""#;
            let result = try_type_check(source);
            always!(result.is_ok(), "Empty source should succeed");
        }
    }
}
...
mod type_error_tests {
    ...
    fn test_type_checker_completes_on_valid_code() {
        ...
        let arena = build_ast(source.to_string());
        let result = TypeCheckerBuilder::build_typed_context(arena);
        always!(result.is_ok(), "Type checker should succeed on valid code");
    }
