(module $output
  ...
  (func $block_ends (;0;) (type 0) (param $b i32) (result i64)
    (local $__frame_ptr i32) (local i64 i64 i64 i32)
    global.get 0
    i32.const 160
    i32.sub
  ...
  (func $call_block_body (;4;) (type 4) (result i64)
    (local $y i32) (local $__frame_ptr i32) (local i64 i64 i64 i32)
    global.get 0
    i32.const 160
    i32.sub
    local.tee $__frame_ptr
  ...
  (func $block_value_semantics (;5;) (type 5) (result i64)
    (local $z i32) (local $ignored i64) (local $__frame_ptr i32) (local i64 i64 i64 i32)
    global.get 0
    i32.const 160
    i32.sub
    local.tee $__frame_ptr
  ...
  (func $frame_edges (;6;) (type 6) (param $f i32) (result i32)
    (local $__frame_ptr i32) (local i32 i32 i32 i32)
    global.get 0
    i32.const 144
    i32.sub
    local.tee $__frame_ptr
  ...
  (@custom "inference.checked" (after code) "\01\05\00\04\05\06\08")
)
