(module $output
  ...
  (func $call_receiver_and_part (;1;) (type 1) (result i32)
    (local $h i32) (local $inner i32) (local $__frame_ptr i32) (local i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func $call_receiver_and_receiver (;2;) (type 2) (result i32)
    (local $g i32) (local $inner i32) (local $__frame_ptr i32) (local i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
    local.tee $__frame_ptr
  ...
  (func $call_mut_receiver_and_part (;3;) (type 3) (result i32)
    (local $k i32) (local $inner i32) (local $__frame_ptr i32) (local i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
    local.tee $__frame_ptr
  ...
  (func $call_mut_receiver_and_receiver (;4;) (type 4) (result i32)
    (local $r i32) (local $inner i32) (local $__frame_ptr i32) (local i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
    local.tee $__frame_ptr
  ...
  (func $call_native_sub_object (;5;) (type 5) (result i32)
    (local $m i32) (local $inner i32) (local $__frame_ptr i32) (local i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
    local.tee $__frame_ptr
  ...
  (@custom "inference.checked" (after code) "\01\0a\00\01\02\03\04\05\06\07\08\09")
)
