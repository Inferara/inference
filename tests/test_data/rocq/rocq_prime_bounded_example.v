...
Definition rocq_prime_bounded_example : module := {|
  mod_types :=
...
Definition rocq_prime_bounded_example__prime_properties_bounded_hspec1 : hassert :=
...
Definition rocq_prime_bounded_example__prime_properties_bounded_specs : list hassert := (rocq_prime_bounded_example__prime_properties_bounded_hspec1 :: nil).

Section Host.
Context `{ho: host}.

Theorem valid_rocq_prime_bounded_example : ValidModule rocq_prime_bounded_example.
Proof.
  (* TODO: fill the proof *)
Admitted.

Theorem valid_rocq_prime_bounded_example__prime_properties_bounded : ValidSpec rocq_prime_bounded_example rocq_prime_bounded_example__prime_properties_bounded_specs.
Proof.
  (* TODO: fill the proof *)
Admitted.
