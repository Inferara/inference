...
fn format_operator(op: &Operator) -> String {
    match op {
        ...
        // --- Memory instructions ---
        Operator::I32Load(a, b) => format!("i32.load align={a} offset={b}"),
        Operator::I64Load(a, b) => format!("i64.load align={a} offset={b}"),
        Operator::F32Load(a, b) => format!("f32.load align={a} offset={b}"),
        Operator::F64Load(a, b) => format!("f64.load align={a} offset={b}"),
        Operator::I32Load8_s(a, b) => format!("i32.load8_s align={a} offset={b}"),
        Operator::I32Load8_u(a, b) => format!("i32.load8_u align={a} offset={b}"),
        Operator::I32Load16_s(a, b) => format!("i32.load16_s align={a} offset={b}"),
        Operator::I32Load16_u(a, b) => format!("i32.load16_u align={a} offset={b}"),
        Operator::I64Load8_s(a, b) => format!("i64.load8_s align={a} offset={b}"),
        Operator::I64Load8_u(a, b) => format!("i64.load8_u align={a} offset={b}"),
        Operator::I64Load16_s(a, b) => format!("i64.load16_s align={a} offset={b}"),
        Operator::I64Load16_u(a, b) => format!("i64.load16_u align={a} offset={b}"),
        Operator::I64Load32_s(a, b) => format!("i64.load32_s align={a} offset={b}"),
        Operator::I64Load32_u(a, b) => format!("i64.load32_u align={a} offset={b}"),
        Operator::I32Store(a, b) => format!("i32.store align={a} offset={b}"),
        Operator::I64Store(a, b) => format!("i64.store align={a} offset={b}"),
        Operator::F32Store(a, b) => format!("f32.store align={a} offset={b}"),
        Operator::F64Store(a, b) => format!("f64.store align={a} offset={b}"),
        Operator::I32Store8(a, b) => format!("i32.store8 align={a} offset={b}"),
        Operator::I32Store16(a, b) => format!("i32.store16 align={a} offset={b}"),
        Operator::I64Store8(a, b) => format!("i64.store8 align={a} offset={b}"),
        Operator::I64Store16(a, b) => format!("i64.store16 align={a} offset={b}"),
        Operator::I64Store32(a, b) => format!("i64.store32 align={a} offset={b}"),
    ...
    while !reader.eof() {
        ...
        match clone.read_operator() {
            Ok(op) => {
                ...
                let _ = write!(offset_str, "0x{start:08x}");
                let mnemonic = format_operator(&op);
                let _ = writeln!(output, "{hex_str:12}  {offset_str:10}  {mnemonic}");
                reader = clone;
            }
            Err(e) => {
                let _ = writeln!(output, "Error at offset 0x{start:08x}: {e}");
                break;
            }
        }
    }
